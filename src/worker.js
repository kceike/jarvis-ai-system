...
<body>
  ...
  <script>
    (function(){
      ...
      var state={conversations:[],active:"",attachments:[],sending:false,listening:false,speaking:false,syncing:false,syncApplying:false,syncTimer:null,syncUnavailable:false,syncMeta:{deviceId:"",revision:0,settingsUpdatedAt:0,memoryClearedAt:0,tombstones:{}},settings:{provider:"cloudflare",cloudModel:"balanced",ollamaUrl:"http://localhost:11434/v1",ollamaModel:"qwen3:4b",webSearch:false,memoryEnabled:true,cloudSync:true,reflectionMode:true,missionControlEnabled:true,screenVisionEnabled:true,itCopilotEnabled:true,proactiveBriefingEnabled:true,autoSpeak:true,wakeWordEnabled:false,concise:false,creativity:.55,title:"sir",weatherLocation:"Iloilo City, Philippines"}};
      var HELP_SECTIONS=[
...
<body>
  ...
  <main class="login">
    ...
    <div class="secure"><b>●</b> SINGLE-USER SECURE SESSION · BUILD 1.12.5</div>
  </main>
  <script>
    (function(){
...
export default {
  async fetch(request, env = {}, ctx = {}) {
    ...
    if (url.pathname === "/api/health") {
      return json({ service: "JARVIS", status: "online", build: "1.12.5", ai: Boolean(env.AI) });
    }

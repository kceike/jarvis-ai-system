  ...
  <div class="modal" id="helpModal">
    <section class="settings help-center" role="dialog" aria-modal="true" aria-label="JARVIS Help Center">
      ...
      <div class="help-scroll" id="helpScroll">
        <div class="help-summary"><strong>COMPLETE OFFLINE GUIDE · VERSION 1.13.8</strong><br>All earlier JARVIS functions remain available. Search below, run a safe example, copy everything, or save all command and function instructions as a Markdown file.</div>
    ...
    (function(){
      ...
      var HELP_SECTIONS=[
        ...
        {title:"ADVANCED INTELLIGENCE AND MULTIMODAL COMMANDS",items:[
          {name:"Upgrade compatibility — no removed functions",description:"Version 1.13.8 retains every v1.13.7 capability and all earlier slash commands. The Gemini chat-response repair and Help Center additions are upgrades: they do not remove Cloudflare AI, Ollama, Vision, voice, wake phrase, memory/RAG, sync, research, file analysis, Mission Control, Windows tools, updater, or manual provider controls."},
        ...
        {title:"APPLICATION, SECURITY, AND UPDATE FUNCTIONS",items:[
          ...
          {name:"Function-retention policy",description:"Updates are additive unless a function is unsafe, broken, or explicitly requested for removal. Version 1.13.8 keeps the earlier user-facing functions and their safety boundaries. Help Center entries are tested against the corresponding command and feature markers before release."},
...
<body>
  ...
  <main class="login">
    ...
    <div class="secure"><b>●</b> SINGLE-USER SECURE SESSION · BUILD 1.13.8</div>
  </main>
  <script>
    (function(){
...
export default {
  async fetch(request, env = {}, ctx = {}) {
    ...
    if (url.pathname === "/api/health") {
      return json({ service: "JARVIS", status: "online", build: "1.13.8", ai: Boolean(env.AI) });
    }

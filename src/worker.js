...
<body>
  ...
  <script>
    (function(){
      ...
      var state={conversations:[],active:"",attachments:[],knowledgeDraft:null,sending:false,listening:false,speaking:false,syncing:false,syncApplying:false,syncTimer:null,syncUnavailable:false,syncMeta:{deviceId:"",revision:0,settingsUpdatedAt:0,memoryClearedAt:0,tombstones:{}},settings:{provider:"cloudflare",cloudModel:"balanced",ollamaUrl:"http://localhost:11434/v1",ollamaModel:"qwen3:4b",webSearch:false,memoryEnabled:true,cloudSync:true,reflectionMode:true,missionControlEnabled:true,screenVisionEnabled:true,itCopilotEnabled:true,proactiveBriefingEnabled:true,knowledgeAgentEnabled:true,autoSpeak:true,wakeWordEnabled:false,concise:false,creativity:.55,title:"sir",weatherLocation:"Iloilo City, Philippines"}};
      var HELP_SECTIONS=[
      ...
      function syncSettings(){return{cloudModel:state.settings.cloudModel,webSearch:!!state.settings.webSearch,memoryEnabled:!!state.settings.memoryEnabled,reflectionMode:state.settings.reflectionMode!==false,missionControlEnabled:state.settings.missionControlEnabled!==false,screenVisionEnabled:state.settings.screenVisionEnabled!==false,itCopilotEnabled:state.settings.itCopilotEnabled!==false,proactiveBriefingEnabled:state.settings.proactiveBriefingEnabled!==false,knowledgeAgentEnabled:state.settings.knowledgeAgentEnabled!==false,autoSpeak:!!state.settings.autoSpeak,concise:!!state.settings.concise,creativity:Number(state.settings.creativity),title:String(state.settings.title||""),weatherLocation:String(state.settings.weatherLocation||"Iloilo City, Philippines").slice(0,120)}}

...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}html,body{height:100%;margin:0}body{background:var(--bg);color:var(--ink);font-family:Inter,"Segoe UI",Arial,sans-serif;overflow:hidden}button,input,textarea,select{color:inherit;font:inherit}button{cursor:pointer}button:focus-visible,input:focus-visible,textarea:focus-visible,select:focus-visible{outline:1px solid var(--cyan);outline-offset:2px}::selection{background:#225d69;color:#fff}::-webkit-scrollbar{width:5px;height:5px}::-webkit-scrollbar-thumb{background:#184450;border-radius:8px}
    ...
    @media(max-width:560px){.top{flex-basis:55px;padding:0 9px}.diamond{height:26px;width:26px}.am-copy small{display:none}.top-actions button:nth-child(2),.top-actions button:nth-child(3){display:none}.avatar{margin-left:0}.welcome{justify-content:flex-start;padding:31px 14px var(--composer-inset)}.reactor-stage{margin:-12px 0 -5px;transform:scale(.82)}.welcome h1{font-size:29px}.welcome>p.copy{font-size:11px;margin-bottom:17px;max-width:315px}.cards{gap:6px;grid-template-columns:1fr}.card{min-height:51px}.stream{padding:19px 11px calc(var(--composer-inset) + 18px)}.message{gap:7px}.msg-avatar{flex-basis:31px;height:31px}.msg-avatar .mini{transform:scale(.84)}.msg-col{max-width:calc(100% - 38px)}.bubble{font-size:11px;padding:11px}.composer-zone{padding:33px 7px 7px}.composer{padding:8px}.composer textarea{font-size:11px}.hint{display:none}.send span{display:none}.disclaimer{font-size:6px}.settings{max-height:92dvh;overflow:auto;padding:16px}.setting{align-items:flex-start;flex-wrap:wrap;padding:12px 0}.setting input[type=range]{margin-left:auto;width:48%}.setting select,.setting input[type=text],.setting input[type=url]{margin-left:auto;max-width:100%}.agent-matrix{grid-template-columns:1fr}.matrix-arrow{transform:rotate(90deg)}.matrix-tools{grid-column:1}.matrix-note{grid-column:1}}
...
<body>
  ...
  <script>
    (function(){
      ...
      document.addEventListener("keydown",function(e){if(e.key==="Escape"&&q("#modal").classList.contains("open")){e.preventDefault();closeSettings()}});
...
<body>
  ...
  <main class="login">
    ...
    <div class="secure"><b>●</b> SINGLE-USER SECURE SESSION · BUILD 1.10.1</div>
  </main>
  <script>
    (function(){
...
export default {
  async fetch(request, env = {}, ctx = {}) {
    ...
    if (url.pathname === "/api/health") {
      return json({ service: "JARVIS", status: "online", build: "1.10.1", ai: Boolean(env.AI) });
    }

...
JARVIS 1.13.5 includes a secure Electron desktop wrapper and standard electron-builder configurations for two Windows formats:

- `JARVIS-AI-Setup-1.13.5-x64.exe` — assisted NSIS installer for normal personal installation.
- `JARVIS-AI-1.13.5-x64.msi` — WiX/MSI installer for IT deployment, SCCM, Intune, Group Policy, and standard `/quiet` or `/passive` installation.
...
The v1.13.5 upgrade adds universal natural-language intent routing and input-based chat/code/image mode selection while retaining every free-first capability and safeguard.
